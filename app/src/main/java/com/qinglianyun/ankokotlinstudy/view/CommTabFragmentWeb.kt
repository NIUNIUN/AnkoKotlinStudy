 ...
 */
class CommTabFragmentWeb : BaseFragment<ICommTabView, CommTabPresenter>(), ICommTabView {
    private val TAG: String = CommTabFragmentWeb::class.java.simpleName
...
//        return layoutId
    ...
    override fun initViews() {
        mRvCommom = mActivity.findViewById<RecyclerView>(R.id.rv_commom_data_web)
        mSwrlComm = mActivity.findViewById(R.id.srl_commom_web)
...
//        fun newInstance(type: String) = CommTabFragmentWeb().apply {
//            var bundle = Bundle()
//            bundle.putString(TAB_TYPE_KEY, type)
//            this.arguments = bundle
//        }

        fun newInstance() = CommTabFragmentWeb()
    }
